        ...
        <div className="overflow-x-auto my-4">
          <table className="min-w-full divide-y divide-neutral-200 border border-neutral-200">
            ...
            <tbody className="bg-white divide-y divide-neutral-200">
              <tr>
                <td className="px-4 py-3 text-sm text-neutral-700"><strong>Trước điều trị</strong></td>
                <td className="px-4 py-3 text-sm text-neutral-700">30-35 kcal/kg</td>
                <td className="px-4 py-3 text-sm text-neutral-700">1.2-1.5 g/kg</td>
                <td className="px-4 py-3 text-sm text-neutral-700">Cải thiện tình trạng dinh dưỡng</td>
                <td className="px-4 py-3 text-sm text-neutral-700">Chuẩn bị cho điều trị</td>
              </tr>
              <tr className="bg-neutral-50">
                <td className="px-4 py-3 text-sm text-neutral-700"><strong>Trong điều trị</strong></td>
                <td className="px-4 py-3 text-sm text-neutral-700">30-40 kcal/kg</td>
                <td className="px-4 py-3 text-sm text-neutral-700">1.5-2.0 g/kg</td>
                <td className="px-4 py-3 text-sm text-neutral-700">Duy trì dinh dưỡng, quản lý tác dụng phụ</td>
                <td className="px-4 py-3 text-sm text-neutral-700">Tăng nếu suy dinh dưỡng</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm text-neutral-700"><strong>Sau điều trị</strong></td>
                <td className="px-4 py-3 text-sm text-neutral-700">30-35 kcal/kg</td>
                <td className="px-4 py-3 text-sm text-neutral-700">1.2-1.5 g/kg</td>
                <td className="px-4 py-3 text-sm text-neutral-700">Phục hồi, phòng ngừa tái phát</td>
                <td className="px-4 py-3 text-sm text-neutral-700">Điều chỉnh theo đáp ứng</td>
              </tr>
            </tbody>
          </table>
        </div>
            ...
            <table className="min-w-full divide-y divide-neutral-200 border border-neutral-200">
              ...
              <tbody className="bg-white divide-y divide-neutral-200">
                <tr>
                  ...
                  <td className="px-4 py-3 text-sm text-neutral-700">Hàng tuần hoặc thường xuyên hơn</td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Duy trì ổn định, không giảm &gt; 5%</td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Theo dõi suy dinh dưỡng</td>
                </tr>
                <tr className="bg-neutral-50">
                  <td className="px-4 py-3 text-sm text-neutral-700"><strong>Albumin</strong></td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Mỗi 1-3 tháng</td>
                ...
                <tr>
                  <td className="px-4 py-3 text-sm text-neutral-700"><strong>Lượng ăn vào</strong></td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Hàng ngày hoặc thường xuyên</td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Đủ năng lượng và protein</td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Đánh giá tuân thủ và khả năng dung nạp</td>
                </tr>
                <tr className="bg-neutral-50">
                  <td className="px-4 py-3 text-sm text-neutral-700"><strong>Tác dụng phụ</strong></td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Mỗi lần khám</td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Kiểm soát tốt</td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Buồn nôn, nôn, tiêu chảy, thay đổi vị giác</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-sm text-neutral-700"><strong>Vi chất</strong></td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Nếu có thiếu hụt hoặc triệu chứng</td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Bình thường</td>
                  <td className="px-4 py-3 text-sm text-neutral-700">Sắt, B12, folate, vitamin D, kẽm</td>
                </tr>
              </tbody>
            </table>
          </div>
