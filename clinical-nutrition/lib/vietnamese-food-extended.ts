...
/**
 * Database thực phẩm Việt Nam với thông tin đầy đủ (thô, chưa khử trùng id)
 */
export const extendedFoodDatabase: ExtendedFoodItem[] = [
  ...
  },
  {
    ...
    vitaminB6: 0.3,
    vitaminB12: 0.4,
    commonServing: "100g (1 miếng vừa, đã bỏ da)",
    gout: {
      purine: 120,
      purineLevel: 'medium',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng thịt vịt bỏ da (100g)' },
    ],
  },
  {
    id: "thit-ngan",
    name: "Thịt ngan (bỏ da)",
    nameEn: "Muscovy duck meat (skinless)",
    category: "meat",
    servingSize: 100,
    servingUnit: "g",
    calories: 145,
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng thịt ngan bỏ da (100g)' },
    ],
  },
  {
    id: "thit-ngong",
    name: "Thịt ngỗng (bỏ da)",
    nameEn: "Goose meat (skinless)",
    category: "meat",
    servingSize: 100,
    servingUnit: "g",
    calories: 160,
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng thịt ngỗng bỏ da (100g)' },
    ],
  },
  {
    id: "thit-de",
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng thịt dê (100g)' },
    ],
  },
  {
    id: "thit-cuu",
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng thịt cừu (100g)' },
    ],
  },
  {
    id: "thit-tho",
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng thịt thỏ (100g)' },
    ],
  },
  {
    id: "thit-bo-than-ngoai",
    name: "Thịt bò thăn ngoài",
    nameEn: "Beef sirloin",
    category: "meat",
    servingSize: 100,
    servingUnit: "g",
    ...
    sodium: 60,
    iron: 2.7,
    commonServing: "100g (1 miếng thăn)",
    gout: {
      purine: 135,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng thăn bò (100g)' },
    ],
  },
  {
    id: "thit-bo-bap",
    ...
    sodium: 65,
    iron: 2.8,
    commonServing: "100g (1 khoanh bắp)",
    gout: {
      purine: 140,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 80, description: '1 khoanh bắp bò (80–100g)' },
    ],
  },
  {
    id: "thit-heo-ba-roi",
    ...
    sodium: 73,
    iron: 0.7,
    commonServing: "1 miếng ba rọi nhỏ (~50g)",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 50, description: '1 miếng ba rọi nhỏ (50g)' },
    ],
  },
  {
    id: "suon-heo",
    ...
    sodium: 75,
    iron: 1.1,
    commonServing: "2–3 miếng sườn nhỏ (~100g)",
    gout: {
      purine: 140,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 35, description: '1 miếng sườn nhỏ (35g)' },
    ],
  },
  {
    id: "gan-lon",
  ...
  },
  {
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng cá chép nấu chín (100g)' },
    ],
  },
  {
    id: "ca-tram",
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng cá trắm nấu chín (100g)' },
    ],
  },
  {
    id: "ca-ro-phi",
    ...
    fat: 1.7,
    sodium: 52,
    commonServing: "100g (1 miếng phi lê)",
    gout: {
      purine: 110,
      purineLevel: 'medium',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng phi lê cá rô phi (100g)' },
    ],
  },
  {
    id: "ca-me",
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng cá mè nấu chín (100g)' },
    ],
  },
  {
    id: "ca-tre",
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng cá trê nấu chín (100g)' },
    ],
  },
  {
    id: "ca-bong",
    ...
    fat: 3.0,
    sodium: 60,
    commonServing: "100g (nhiều con nhỏ)",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 15, description: '1 con cá bống vừa (15g)' },
    ],
  },
  {
    id: "ca-chach",
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 20, description: '1 con cá chạch vừa (20g)' },
    ],
  },
  {
    id: "ca-moi-tuoi",
    ...
    phosphorus: 490,
    cholesterol: 142,
    commonServing: "100g (2–3 con vừa)",
    notes: "Cá béo giàu omega-3; tốt cho tim mạch nhưng có cholesterol và purine tương đối cao.",
    gout: {
      purine: 160,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 35, description: '1 con cá mòi vừa (35g)' },
    ],
  },
  {
    id: "ca-trich-tuoi",
    ...
    phosphorus: 400,
    cholesterol: 77,
    commonServing: "100g (2–3 khúc vừa)",
    notes: "Giàu omega-3; phù hợp chế độ ăn tốt cho tim mạch nếu không chiên rán quá nhiều dầu.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 40, description: '1 khúc cá trích (40g)' },
    ],
  },
  {
    id: "ca-ngu-dai-duong",
    ...
    cholesterol: 47,
    commonServing: "100g (1 miếng phi lê)",
    notes: "Giàu protein và omega-3 nhưng có nguy cơ tích lũy thủy ngân; không nên ăn quá thường xuyên ở phụ nữ mang thai/trẻ nhỏ.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 100, description: '1 miếng phi lê cá ngừ (100g)' },
    ],
  },
  {
    id: "ca-chim-trang",
    name: "Cá chim trắng",
    nameEn: "White pomfret",
    category: "seafood",
    servingSize: 100,
    servingUnit: "g",
    calories: 105,
    ...
    phosphorus: 200,
    cholesterol: 65,
    commonServing: "1/2 con cá chim cỡ vừa (~100g thịt)",
    notes: "Thịt trắng, ít béo; phù hợp cho nhiều chế độ ăn, kể cả bệnh tim mạch nếu chế biến ít dầu mỡ.",
    gout: {
      purine: 120,
      purineLevel: 'medium',
    },
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 200, description: '1 con cá chim trắng vừa (~200g trước chế biến)' },
    ],
  },
  {
    id: "ca-chim-den",
    ...
    phosphorus: 210,
    cholesterol: 70,
    commonServing: "1/2 con cá chim đen cỡ vừa (~100g thịt)",
    notes: "Giàu protein, hơi béo hơn cá chim trắng; phù hợp nếu chế biến ít dầu.",
    gout: {
      purine: 130,
      purineLevel: 'medium',
    },
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 220, description: '1 con cá chim đen vừa (~220g trước chế biến)' },
    ],
  },
  {
    id: "ca-ho-bien",
    ...
    phosphorus: 200,
    cholesterol: 65,
    commonServing: "2–3 khúc (~100g)",
    notes: "Thịt mềm, ít béo; thường dùng kho, chiên; chú ý lượng dầu nếu chiên ngập dầu.",
    gout: {
      purine: 130,
      purineLevel: 'medium',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 35, description: '1 khúc cá hố (35g)' },
    ],
  },
  {
    id: "ca-bac-ma",
    name: "Cá bạc má",
    nameEn: "Indian mackerel (short mackerel)",
    category: "seafood",
    servingSize: 100,
    servingUnit: "g",
    calories: 139,
    ...
    notes: "Cá béo giàu omega-3; tốt cho tim mạch nhưng cần kiểm soát lượng cho bệnh nhân gout.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 120, description: '1 con cá bạc má vừa (~120g trước chế biến)' },
    ],
  },
  {
    id: "tom",
  ...
  // ========================================================================
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu hạt cải giàu acid béo không bão hòa; dùng thay mỡ động vật.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu đậu nành phổ biến, giàu acid béo không bão hòa; nên dùng lượng vừa phải.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa cà phê (5g)",
    notes: "Dầu mè thơm, dùng chủ yếu để nêm; giàu chất béo không bão hòa.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    vitaminA: 40000,
    commonServing: "1 thìa cà phê (5g)",
    notes: "Rất giàu carotenoid (tiền vitamin A); dùng vài giọt–1 thìa cà phê mỗi ngày, tránh lạm dụng.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu dừa chứa nhiều chất béo bão hòa; người bệnh tim mạch nên hạn chế.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu đậu phộng giàu chất béo không bão hòa; chú ý dị ứng đậu phộng.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Giàu acid béo không bão hòa đơn; phù hợp chế độ ăn tốt cho tim mạch.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu bắp giàu omega-6; dùng vừa phải, cân đối với omega-3.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu cây rum giàu acid béo không bão hòa; dùng thay mỡ động vật.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu macca rất giàu chất béo không bão hòa đơn; phù hợp chế độ ăn Địa Trung Hải.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu hướng dương giàu vitamin E và acid béo không bão hòa; dùng vừa phải.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Giàu omega-3 nguồn thực vật (ALA); dùng nêm nguội, không chiên ở nhiệt độ cao.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  {
    id: "dau-sachi-inchi",
    name: "Dầu Sachi inchi",
    nameEn: "Sacha inchi oil",
    category: "condiments",
    servingSize: 100,
    servingUnit: "g",
    calories: 884,
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu Sacha inchi rất giàu omega-3; dùng liều nhỏ hàng ngày.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu óc chó giàu omega-3 và omega-6; dùng nêm salad, không nên chiên lâu.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu olive extra-virgin là lựa chọn tốt cho tim mạch; dùng xào nhẹ, trộn salad.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    sodium: 0,
    cholesterol: 300,
    commonServing: "1 thìa cà phê (5g) hoặc viên bổ sung theo chỉ định",
    notes: "Nguồn omega-3 (EPA, DHA) cô đặc; dùng theo chỉ định bác sĩ, chú ý chống đông và rối loạn mỡ máu.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu cám gạo chứa oryzanol, hỗ trợ giảm cholesterol; thích hợp chiên xào.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu hạt nho giàu vitamin E và chất chống oxy hóa; dùng trộn salad hoặc xào nhẹ.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  },
  {
    ...
    cholesterol: 0,
    commonServing: "1 thìa canh (15g)",
    notes: "Dầu cọ giàu chất béo bão hòa; người bệnh tim mạch nên hạn chế.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
  ...
  // ========================================================================
  // Thực phẩm bổ sung: bánh, rau, gia vị, đặc sản
  // ========================================================================
  {
    id: "banh-uot",
    name: "Bánh ướt",
    nameEn: "Steamed rice sheet",
    category: "rice-noodles",
    servingSize: 100,
    servingUnit: "g",
    calories: 110,
    ...
    fiber: 0.5,
    sodium: 200,
    commonServing: "1 dĩa (~150g)",
    notes: "Tinh bột từ gạo; ăn kèm nước chấm và topping sẽ làm tăng thêm natri và năng lượng.",
    diabetes: {
      glycemicIndex: 65,
      glycemicLoad: 15,
      carbPerPortion: 35,
    ...
    vietnameseUnits: [
      { unit: 'dia', weight: 150, description: '1 dĩa vừa' },
    ],
  },
  {
    id: "ca-tim",
    ...
    vitaminC: 2,
    commonServing: "1 quả vừa (~100g)",
    notes: "Giàu chất xơ, năng lượng thấp; phù hợp cho kiểm soát cân nặng và đái tháo đường.",
    vietnameseUnits: [
      { unit: 'qua', weight: 100, description: '1 quả vừa' },
    ],
  },
  {
    ...
    calcium: 12,
    iron: 0.4,
    commonServing: "5–6 quả nhỏ (~80–100g)",
    notes: "Thường ăn sống hoặc muối chua; chú ý natri nếu ăn kèm mắm/muối.",
    vietnameseUnits: [
      { unit: 'qua', weight: 15, description: '1 quả nhỏ' },
    ],
  },
  {
    id: "gac",
    name: "Gấc (thịt quả)",
    nameEn: "Gac fruit pulp",
    category: "fruits",
    servingSize: 100,
    servingUnit: "g",
    calories: 80,
    ...
    vitaminA: 10000,
    vitaminC: 40,
    commonServing: "2–3 múi nhỏ (~50g)",
    notes: "Rất giàu carotenoid; thường dùng phối với gạo (xôi gấc). Người bệnh gan nên tham khảo bác sĩ khi dùng dạng bổ sung.",
    vietnameseUnits: [
      { unit: 'mieng', weight: 20, description: '1 miếng nhỏ' },
    ],
  },
  {
    id: "muop",
    ...
    vitaminC: 12,
    commonServing: "1 quả vừa (~150g)",
    notes: "Năng lượng thấp, giàu nước; phù hợp cho người thừa cân, đái tháo đường.",
    vietnameseUnits: [
      { unit: 'qua', weight: 150, description: '1 quả vừa' },
    ],
  },
  {
    ...
    sodium: 5,
    potassium: 240,
    commonServing: "1 phần (~100g thịt mít non)",
    notes: "Giàu chất xơ, thường dùng làm món kho/chay; phù hợp kiểm soát cân nặng nếu không thêm nhiều dầu mỡ.",
    vietnameseUnits: [
      { unit: 'mieng', weight: 30, description: '1 miếng vừa' },
    ],
  },
  {
    id: "ngo-gai",
    name: "Ngò gai",
    nameEn: "Sawtooth coriander",
    category: "vegetables",
    servingSize: 100,
    servingUnit: "g",
    calories: 30,
    ...
    fiber: 3.0,
    vitaminC: 25,
    commonServing: "1 nắm rau sống (~10g)",
    notes: "Dùng lượng nhỏ làm rau thơm; năng lượng không đáng kể nhưng có thêm vi chất.",
    vietnameseUnits: [
      { unit: 'nam', weight: 10, description: '1 nắm nhỏ' },
    ],
  },
  {
    id: "nen",
    name: "Nén (hành tăm)",
    nameEn: "Vietnamese shallot (small onion)",
    category: "vegetables",
    servingSize: 100,
    servingUnit: "g",
    calories: 72,
    ...
    potassium: 334,
    vitaminC: 8,
    commonServing: "3–5 củ nhỏ (~10g)",
    notes: "Gia vị họ hành; dùng lượng nhỏ, hỗ trợ tăng hương vị món ăn.",
    vietnameseUnits: [
      { unit: 'nam', weight: 10, description: '1 nắm nhỏ (3–5 củ)' },
    ],
  },
  {
    id: "rieng",
    ...
    sodium: 10,
    potassium: 250,
    commonServing: "3–4 lát (~10g)",
    notes: "Gia vị thơm, dùng trong món kho/canh chua; năng lượng không đáng kể do dùng ít.",
    vietnameseUnits: [
      { unit: 'mieng', weight: 3, description: '1 lát mỏng' },
    ],
  },
  {
    id: "hung-duoi",
    name: "Húng duỗi",
    nameEn: "Thai basil (Hung dui)",
    category: "vegetables",
    servingSize: 100,
    servingUnit: "g",
    calories: 30,
    ...
    fiber: 3.0,
    vitaminC: 20,
    commonServing: "1 nắm rau thơm (~10g)",
    notes: "Rau thơm ăn kèm; năng lượng rất thấp.",
    vietnameseUnits: [
      { unit: 'nam', weight: 10, description: '1 nắm nhỏ' },
    ],
  },
  {
    ...
    vitaminC: 20,
    commonServing: "1 nắm rau thơm (~10g)",
    notes: "Rau thơm đặc trưng món lẩu gà lá é; dùng lượng nhỏ.",
    vietnameseUnits: [
      { unit: 'nam', weight: 10, description: '1 nắm nhỏ' },
    ],
  },
  {
    ...
    fat: 4.0,
    cholesterol: 70,
    commonServing: "1 phần thịt sóc nấu chín (~100g)",
    notes: "Thịt thú rừng nạc, giàu protein; cần chú ý nguồn gốc an toàn thực phẩm.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
  ...
  {
    id: "chanh-day",
    name: "Chanh dây (passion fruit)",
    nameEn: "Passion fruit pulp",
    category: "fruits",
    servingSize: 100,
    servingUnit: "g",
    calories: 97,
    ...
    potassium: 348,
    vitaminC: 30,
    commonServing: "2 quả vừa (~80–100g ruột)",
    notes: "Giàu chất xơ và vitamin C; khi pha nước nên hạn chế thêm đường cho bệnh nhân ĐTĐ.",
    vietnameseUnits: [
      { unit: 'qua', weight: 40, description: '1 quả (ruột + hạt)' },
    ],
  },
  {
    id: "mam-ca-sac",
    name: "Mắm cá sặc",
    nameEn: "Fermented snake-skin gourami",
    category: "condiments",
    servingSize: 100,
    servingUnit: "g",
    calories: 120,
    ...
    iron: 1.5,
    phosphorus: 150,
    commonServing: "1–2 miếng nhỏ (~15g)",
    notes: "Rất mặn (natri rất cao); bệnh THA, suy tim, bệnh thận nên hạn chế tối đa.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 7, description: '1 miếng nhỏ' },
    ],
  },
  {
    id: "mam-ca-linh",
    name: "Mắm cá linh",
    nameEn: "Fermented linh fish",
    category: "condiments",
    servingSize: 100,
    servingUnit: "g",
    calories: 120,
    ...
    iron: 1.5,
    phosphorus: 150,
    commonServing: "1–2 muỗng nhỏ (~15g)",
    notes: "Rất mặn; dùng lượng rất nhỏ để nêm, bệnh THA/thận cần hạn chế nghiêm ngặt.",
    vietnameseUnits: [
      { unit: 'thia-ca-phe', weight: 5, description: '1 thìa cà phê' },
    ],
  },
  {
    ...
    iron: 2.0,
    phosphorus: 200,
    commonServing: "1 con nhỏ (~20g)",
    notes: "Rất mặn; bệnh thận, THA, suy tim nên tránh hoặc chỉ nếm rất ít.",
    vietnameseUnits: [
      { unit: 'con', weight: 20, description: '1 con nhỏ' },
    ],
  },
  {
    id: "mam-muc",
    name: "Mắm mực",
    nameEn: "Fermented squid",
    category: "condiments",
    servingSize: 100,
    servingUnit: "g",
    calories: 110,
    ...
    potassium: 230,
    commonServing: "1–2 miếng nhỏ (~15g)",
    notes: "Mặn và có cholesterol; người bệnh tim mạch, gout, thận cần cân nhắc.",
    vietnameseUnits: [
      { unit: 'mieng', weight: 7, description: '1 miếng nhỏ' },
    ],
  },
  {
    ...
    calcium: 120,
    phosphorus: 200,
    commonServing: "1–2 thìa cà phê (~10g)",
    notes: "Mặn và giàu purine; bệnh gout, THA, thận nên hạn chế tối đa.",
    vietnameseUnits: [
      { unit: 'thia-ca-phe', weight: 5, description: '1 thìa cà phê' },
    ],
  },
  {
    ...
    fiber: 1.0,
    sodium: 50,
    commonServing: "2–3 bánh cuốn gỏi (~30g)",
    notes: "Chủ yếu là tinh bột từ gạo; năng lượng tăng nhanh nếu ăn nhiều cuốn.",
    diabetes: {
      glycemicIndex: 70,
      glycemicLoad: 16,
      carbPerPortion: 24,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 10, description: '1 bánh tráng (cỡ trung bình)' },
    ],
  },
  {
    id: "banh-trang-gao-nuong",
    name: "Bánh tráng gạo nướng",
    nameEn: "Grilled rice paper",
    category: "snacks",
    servingSize: 100,
    servingUnit: "g",
    ...
    fiber: 1.5,
    sodium: 300,
    commonServing: "1 cái bánh tráng nướng (~40–50g, tùy topping)",
    notes: "Đồ ăn vặt năng lượng cao; thêm topping trứng, xúc xích, phô mai sẽ tăng thêm nhiều kcal và natri.",
    vietnameseUnits: [
      { unit: 'cai', weight: 45, description: '1 bánh tráng nướng' },
    ],
  },
  {
    id: "tre",
    name: "Tré",
    nameEn: "Fermented pork roll (Tre)",
    category: "meat",
    servingSize: 100,
    servingUnit: "g",
    calories: 250,
    ...
    sodium: 1200,
    cholesterol: 90,
    commonServing: "1 cuộn nhỏ cắt lát (~50g)",
    notes: "Món thịt lên men, mặn và nhiều mỡ; người THA, tim mạch, gout nên hạn chế.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 10, description: '1 lát tré' },
    ],
  },

  // ========================================================================
  // Hạt & đậu ăn vặt lành mạnh
  // ========================================================================
  {
    id: "hanh-nhan",
    name: "Hạnh nhân",
    ...
    zinc: 3.1,
    commonServing: "1 nắm (~30g)",
    notes: "Giàu chất béo không bão hòa, chất xơ và magiê; phù hợp bữa phụ lành mạnh nếu không thêm muối/đường.",
    diabetes: {
      glycemicIndex: 15,
      glycemicLoad: 1,
      carbPerPortion: 7,
    ...
    vietnameseUnits: [
      { unit: 'nam', weight: 30, description: '1 nắm nhỏ' },
    ],
  },
  {
    id: "hat-dieu",
    ...
    zinc: 5.8,
    commonServing: "1 nắm (~30g)",
    notes: "Giàu năng lượng và chất béo tốt; nên dùng lượng nhỏ, hạn chế loại rang muối/ngọt.",
    diabetes: {
      glycemicIndex: 25,
      glycemicLoad: 2,
      carbPerPortion: 9,
  ...
  },
  {
    ...
    magnesium: 592,
    zinc: 7.8,
    commonServing: "1 nắm (~30g, đã bóc vỏ)",
    notes: "Giàu protein thực vật, magiê và kẽm; hữu ích cho tim mạch nếu không thêm muối.",
    diabetes: {
      glycemicIndex: 15,
      glycemicLoad: 1,
      carbPerPortion: 3,
    ...
    vietnameseUnits: [
      { unit: 'nam', weight: 30, description: '1 nắm nhỏ (đã bóc vỏ)' },
    ],
  },
  {
    id: "hat-huong-duong",
    ...
    magnesium: 325,
    zinc: 5.0,
    commonServing: "1 nắm (~30g nhân)",
    notes: "Giàu vitamin E và chất béo không bão hòa; nên chọn loại ít muối.",
    diabetes: {
      glycemicIndex: 20,
      glycemicLoad: 2,
      carbPerPortion: 6,
    ...
    vietnameseUnits: [
      { unit: 'nam', weight: 30, description: '1 nắm nhỏ (nhân đã bóc vỏ)' },
    ],
  },
  {
    id: "hat-de",
    ...
    potassium: 715,
    vitaminC: 26,
    commonServing: "5–6 hạt rang (~50g ruột)",
    notes: "Năng lượng đến từ tinh bột; ăn vừa phải, đặc biệt với ĐTĐ.",
    diabetes: {
      glycemicIndex: 60,
      glycemicLoad: 16,
      carbPerPortion: 27,
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 8, description: '1 hạt (đã bóc vỏ)' },
    ],
  },
  {
    id: "dau-phong-rang",
    ...
    zinc: 3.3,
    commonServing: "1 nắm (~30g)",
    notes: "Giàu năng lượng và chất béo tốt; chú ý dị ứng và hạn chế loại rang muối/ngọt.",
    diabetes: {
      glycemicIndex: 14,
      glycemicLoad: 1,
      carbPerPortion: 5,
  ...
  {
    id: "oc-cho-nguyen-hat",
    name: "Óc chó nguyên hạt",
    nameEn: "Walnuts",
    category: "snacks",
    servingSize: 100,
    servingUnit: "g",
    ...
    magnesium: 158,
    zinc: 3.1,
    commonServing: "3–4 hạt (~30g nhân)",
    notes: "Rất giàu omega-3 thực vật (ALA); tốt cho tim mạch nếu dùng lượng nhỏ mỗi ngày.",
    diabetes: {
      glycemicIndex: 15,
      glycemicLoad: 1,
      carbPerPortion: 4,
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 7, description: '1 nửa hạt (nhân)' },
    ],
  },
  {
    id: "hat-chia",
    ...
    magnesium: 335,
    zinc: 4.6,
    commonServing: "1–2 thìa canh (10–20g)",
    notes: "Rất giàu chất xơ và omega-3 thực vật; nên tăng dần liều và uống đủ nước.",
    diabetes: {
      glycemicIndex: 1,
      glycemicLoad: 1,
      carbPerPortion: 1,
  ...
  {
    id: "hat-lanh-nguyen-hat",
    name: "Hạt lanh (nguyên hạt)",
    nameEn: "Flaxseeds",
    category: "snacks",
    servingSize: 100,
    servingUnit: "g",
    ...
    magnesium: 392,
    zinc: 4.3,
    commonServing: "1–2 thìa canh (10–20g, thường xay/ủ mềm)",
    notes: "Giàu chất xơ và omega-3 (ALA); nên xay/ủ nước trước khi ăn để hấp thu tốt hơn.",
    diabetes: {
      glycemicIndex: 1,
      glycemicLoad: 1,
      carbPerPortion: 1,
  ...
  },
  {
    ...
    magnesium: 351,
    zinc: 7.8,
    commonServing: "1–2 thìa canh (10–20g) rắc lên món ăn",
    notes: "Rất giàu canxi và chất béo tốt; dùng như topping cho cơm, cháo, salad.",
    diabetes: {
      glycemicIndex: 20,
      glycemicLoad: 2,
      carbPerPortion: 5,
  ...
  // ========================================================================
  // Thủy sản, rau củ, nấm và món Việt bổ sung
  // ========================================================================
  {
    id: "tom-hum",
    name: "Tôm hùm",
    ...
    phosphorus: 200,
    cholesterol: 145,
    commonServing: "100g thịt tôm (khoảng 1/2 con cỡ vừa)",
    notes: "Giàu đạm, cholesterol và natri; không nên ăn quá nhiều ở người rối loạn mỡ máu, tăng huyết áp, gout.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 50, description: '1 phần thịt tôm hùm (~50g)' },
    ],
  },
  {
    id: "tom-dat",
    name: "Tôm đất",
    nameEn: "Freshwater small shrimp",
    category: "seafood",
    servingSize: 100,
    servingUnit: "g",
    calories: 90,
    ...
    cholesterol: 160,
    commonServing: "100g (nhiều con nhỏ)",
    notes: "Giàu đạm và purine; người gout nên hạn chế, người thận chú ý lượng kali/phospho.",
    gout: {
      purine: 160,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 5, description: '1 con tôm đất vừa (5g)' },
    ],
  },
  {
    id: "oc-buou",
    ...
    phosphorus: 180,
    cholesterol: 60,
    commonServing: "100g thịt ốc (nhiều con)",
    notes: "Giàu đạm, ít béo; chú ý vệ sinh, nguy cơ ký sinh trùng nếu chế biến không kỹ.",
    gout: {
      purine: 130,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 15, description: '1 con ốc bươu vừa (15g cả vỏ, ~5g thịt)' },
    ],
  },
  {
    id: "oc-huong",
    name: "Ốc hương",
    nameEn: "Babylonia snail",
    category: "seafood",
    servingSize: 100,
    servingUnit: "g",
    calories: 100,
    ...
    phosphorus: 190,
    cholesterol: 70,
    commonServing: "100g thịt ốc (nhiều con nhỏ)",
    notes: "Hải sản giàu đạm; thường chế biến với nhiều muối/bơ/tỏi, cần lưu ý cho bệnh tim mạch, THA.",
    gout: {
      purine: 140,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 12, description: '1 con ốc hương vừa (12g cả vỏ, ~5g thịt)' },
    ],
  },
  {
    id: "bi-dao",
    ...
    potassium: 150,
    vitaminC: 13,
    commonServing: "1 chén bí đao nấu chín (~100g)",
    notes: "Năng lượng rất thấp, giàu nước; phù hợp cho người thừa cân, tăng huyết áp, đái tháo đường.",
    diabetes: {
      glycemicIndex: 15,
      glycemicLoad: 0.5,
      carbPerPortion: 3,
    ...
    vietnameseUnits: [
      { unit: 'bat', weight: 100, description: '1 bát bí đao nấu chín' },
    ],
  },
  {
    id: "nam-huong",
    ...
    potassium: 304,
    phosphorus: 112,
    commonServing: "1 phần nấm hương tươi xào/kho (~50–70g)",
    notes: "Giàu chất xơ, ít năng lượng; nấm khô đậm đặc đạm và purine hơn.",
    gout: {
      purine: 70,
      purineLevel: 'medium',
    },
    ...
    vietnameseUnits: [
      { unit: 'nam', weight: 10, description: '1 tai nấm hương tươi vừa' },
    ],
  },
  {
    id: "nam-rom",
    ...
    potassium: 300,
    phosphorus: 90,
    commonServing: "1 chén nấm rơm xào/kho (~80–100g)",
    notes: "Giàu đạm thực vật, ít năng lượng; thích hợp cho ăn chay và kiểm soát cân nặng.",
    gout: {
      purine: 70,
      purineLevel: 'medium',
    },
    ...
    vietnameseUnits: [
      { unit: 'nam', weight: 8, description: '1 nấm rơm vừa' },
    ],
  },
  {
    id: "banh-beo",
    name: "Bánh bèo",
    nameEn: "Savory rice cake (banh beo)",
    category: "snacks",
    servingSize: 100,
    servingUnit: "g",
    calories: 160,
    ...
    fiber: 0.5,
    sodium: 250,
    commonServing: "1 chén bánh bèo (~30–40g, 50–70kcal tùy topping)",
    notes: "Tinh bột từ bột gạo; topping mỡ hành, ruốc tôm làm tăng mỡ/natri.",
    diabetes: {
      glycemicIndex: 65,
      glycemicLoad: 22,
      carbPerPortion: 20,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 35, description: '1 chén bánh bèo' },
    ],
  },
  {
    id: "ech",
    ...
    potassium: 285,
    phosphorus: 180,
    commonServing: "100g (nhiều miếng nhỏ)",
    notes: "Thịt nạc, ít mỡ; nguồn đạm tốt nhưng cần đảm bảo an toàn ký sinh trùng.",
    gout: {
      purine: 130,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 25, description: '1 miếng ếch (đùi/thịt) nhỏ' },
    ],
  },
  {
    id: "luon",
    ...
    phosphorus: 190,
    cholesterol: 126,
    commonServing: "100g thịt lươn (1–2 khúc)",
    notes: "Giàu omega-3 và vitamin A nhưng nhiều cholesterol; không nên ăn quá thường xuyên ở người rối loạn mỡ máu.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 50, description: '1 khúc lươn (~50g thịt)' },
    ],
  },
  {
    id: "ba-ba",
    name: "Ba ba",
    nameEn: "Softshell turtle",
    category: "meat",
    servingSize: 100,
    servingUnit: "g",
    calories: 120,
    ...
    phosphorus: 200,
    cholesterol: 95,
    commonServing: "100g thịt ba ba (1–2 miếng)",
    notes: "Thịt đặc sản, giàu đạm; người gout, tim mạch cần cân nhắc do purine và cholesterol.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 40, description: '1 miếng thịt ba ba (40–50g)' },
    ],
  },
  {
    id: "ngo",
    ...
    vitaminC: 27,
    vitaminA: 6748,
    commonServing: "1 nắm rau ngò nhỏ (~5–10g)",
    notes: "Rau thơm, năng lượng không đáng kể; chủ yếu tăng hương vị và thêm chút vi chất.",
    vietnameseUnits: [
      { unit: 'nam', weight: 8, description: '1 nắm rau ngò nhỏ' },
    ],
  },

  // ========================================================================
  // Đồ uống có đường & đường / chất tạo ngọt
  // ========================================================================
  {
    id: "nuoc-ngot-lon",
    name: "Nước ngọt có gas (lon)",
    nameEn: "Sugar-sweetened soft drink (can)",
    category: "beverages",
    servingSize: 100,
    servingUnit: "g",
    calories: 42,
    ...
    fiber: 0,
    sodium: 5,
    commonServing: "1 lon 330ml (~140kcal)",
    notes: "Chủ yếu là đường; không có giá trị dinh dưỡng khác. Không khuyến khích cho ĐTĐ, béo phì, NAFLD.",
    diabetes: {
      glycemicIndex: 65,
      glycemicLoad: 21,
      carbPerPortion: 35,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 330, description: '1 lon 330ml' },
    ],
  },
  {
    id: "nuoc-tang-luc",
    ...
    fiber: 0,
    sodium: 60,
    commonServing: "1 lon 250ml (~110kcal)",
    notes: "Nhiều đường và caffein; không phù hợp dùng thường xuyên, đặc biệt ở ĐTĐ, THA, bệnh tim.",
    diabetes: {
      glycemicIndex: 65,
      glycemicLoad: 18,
      carbPerPortion: 27,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 250, description: '1 lon 250ml' },
    ],
  },
  {
    ...
    fiber: 0.5,
    sodium: 30,
    commonServing: "1 ly 500ml (~400kcal, tùy topping)",
    notes: "Nhiều đường và năng lượng; ảnh hưởng xấu đến kiểm soát đường huyết và cân nặng.",
    diabetes: {
      glycemicIndex: 60,
      glycemicLoad: 48,
      carbPerPortion: 80,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 500, description: '1 ly 500ml (chuẩn quán trà sữa)' },
    ],
  },
  {
    id: "nuoc-mia",
    ...
    sodium: 15,
    potassium: 100,
    commonServing: "1 ly 300ml (~225kcal)",
    notes: "Đường đơn cao; ĐTĐ và béo phì nên hạn chế, không uống khi đói.",
    diabetes: {
      glycemicIndex: 65,
      glycemicLoad: 35,
      carbPerPortion: 54,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 300, description: '1 ly 300ml' },
    ],
  },
  {
    id: "nuoc-cam-dong-hop",
    name: "Nước cam đóng hộp",
    nameEn: "Orange juice (boxed)",
    category: "beverages",
    servingSize: 100,
    servingUnit: "g",
    calories: 45,
    ...
    fiber: 0.2,
    vitaminC: 25,
    commonServing: "1 hộp 200ml (~90kcal)",
    notes: "Ít chất xơ hơn cam tươi; tốt hơn nước ngọt nhưng vẫn là nguồn đường lỏng.",
    diabetes: {
      glycemicIndex: 50,
      glycemicLoad: 10,
      carbPerPortion: 21,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 200, description: '1 hộp 200ml' },
    ],
  },
  {
    id: "sinh-to-xoai",
    name: "Sinh tố xoài (có đường)",
    nameEn: "Mango smoothie (with sugar)",
    category: "beverages",
    servingSize: 100,
    servingUnit: "g",
    calories: 90,
    ...
    sodium: 10,
    vitaminC: 20,
    commonServing: "1 ly 300ml (~270kcal)",
    notes: "Nhiều đường nếu thêm sữa đặc/si-rô; ĐTĐ nên chọn ít/không đường, giảm khẩu phần.",
    diabetes: {
      glycemicIndex: 55,
      glycemicLoad: 35,
      carbPerPortion: 63,
  ...
  {
    id: "sinh-to-bo",
    name: "Sinh tố bơ (có sữa đặc)",
    nameEn: "Avocado smoothie (with condensed milk)",
    category: "beverages",
    servingSize: 100,
    servingUnit: "g",
    calories: 150,
    ...
    sodium: 25,
    potassium: 300,
    commonServing: "1 ly 250–300ml (~375–450kcal)",
    notes: "Nhiều năng lượng do bơ + sữa đặc; phù hợp người gầy, không phù hợp ĐTĐ/béo phì nếu uống thường xuyên.",
    diabetes: {
      glycemicIndex: 50,
      glycemicLoad: 24,
      carbPerPortion: 40,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 280, description: '1 ly sinh tố bơ phổ biến' },
    ],
  },
  {
    id: "duong-trang",
    ...
    fiber: 0,
    sodium: 1,
    commonServing: "1 thìa cà phê (~5g, ~20kcal)",
    notes: "Đường tinh luyện; chỉ cung cấp năng lượng rỗng, không vi chất.",
    diabetes: {
      glycemicIndex: 65,
      glycemicLoad: 65,
      carbPerPortion: 5,
    ...
    vietnameseUnits: [
      { unit: 'thia-ca-phe', weight: 5, description: '1 thìa cà phê đường' },
      { unit: 'thia-canh', weight: 15, description: '1 thìa canh đường' },
    ],
  },
  {
    id: "duong-nau",
    ...
    sodium: 10,
    commonServing: "1 thìa cà phê (~5g)",
    notes: "Tương tự đường trắng, chỉ khác màu và mùi; không “lành mạnh” hơn đáng kể.",
    diabetes: {
      glycemicIndex: 65,
      glycemicLoad: 64,
      carbPerPortion: 5,
    ...
    vietnameseUnits: [
      { unit: 'thia-ca-phe', weight: 5, description: '1 thìa cà phê đường nâu' },
    ],
  },
  {
    id: "mat-ong",
    ...
    sodium: 4,
    potassium: 52,
    commonServing: "1 thìa cà phê (~7g, ~21kcal)",
    notes: "Nhiều đường (fructose, glucose); ĐTĐ nên xem như đường thông thường.",
    diabetes: {
      glycemicIndex: 55,
      glycemicLoad: 45,
      carbPerPortion: 6,
    ...
    vietnameseUnits: [
      { unit: 'thia-ca-phe', weight: 7, description: '1 thìa cà phê mật ong' },
      { unit: 'thia-canh', weight: 21, description: '1 thìa canh mật ong' },
    ],
  },
  {
    id: "sua-dac-co-duong",
    ...
    sodium: 127,
    calcium: 284,
    commonServing: "1–2 thìa cà phê (12–24g, ~40–80kcal)",
    notes: "Rất nhiều đường; hay “ẩn” trong cà phê sữa, sinh tố, chè.",
    diabetes: {
      glycemicIndex: 60,
      glycemicLoad: 32,
      carbPerPortion: 6,
    ...
    vietnameseUnits: [
      { unit: 'thia-ca-phe', weight: 6, description: '1 thìa cà phê sữa đặc' },
      { unit: 'thia-canh', weight: 18, description: '1 thìa canh sữa đặc' },
    ],
  },
  {
    id: "siro-duong",
    ...
    fiber: 0,
    sodium: 10,
    commonServing: "1 thìa canh (~20g, ~60kcal)",
    notes: "Thường dùng pha đồ uống, topping; mật độ đường rất cao.",
    diabetes: {
      glycemicIndex: 65,
      glycemicLoad: 50,
      carbPerPortion: 15,
    ...
    vietnameseUnits: [
      { unit: 'thia-ca-phe', weight: 7, description: '1 thìa cà phê si-rô' },
      { unit: 'thia-canh', weight: 20, description: '1 thìa canh si-rô' },
    ],
  },
  {
    id: "chat-ngot-stevia",
    name: "Chất ngọt Stevia",
    nameEn: "Stevia sweetener",
    category: "condiments",
    servingSize: 100,
    servingUnit: "g",
    calories: 5,
    ...
    fiber: 0,
    sodium: 0,
    commonServing: "1 viên/1 gói (~1g, ~0kcal)",
    notes: "Chất ngọt ít/không năng lượng; thường an toàn cho ĐTĐ nếu dùng đúng liều.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 1, description: '1 viên hoặc 1 gói nhỏ' },
    ],
  },
  {
    id: "chat-ngot-aspartame",
    name: "Chất ngọt Aspartame",
    nameEn: "Aspartame sweetener",
    category: "condiments",
    servingSize: 100,
    servingUnit: "g",
    calories: 400,
    ...
    fiber: 0,
    sodium: 0,
    commonServing: "1 viên/1 gói (~0.05g, ~0kcal do liều rất nhỏ)",
    notes: "Ngọt gấp ~200 lần đường; năng lượng rất thấp ở liều sử dụng; dùng theo khuyến cáo an toàn.",
    diabetes: {
      glycemicIndex: 0,
      glycemicLoad: 0,
      carbPerPortion: 0,
    ...
    vietnameseUnits: [
      { unit: 'cai', weight: 0.05, description: '1 viên hoặc 1 gói nhỏ' },
    ],
  },
  ...
  // ========================================================================
  {
    ...
    fat: 17.0,
    cholesterol: 80,
    commonServing: "1 phần thịt bằm xào (~50–70g)",
    notes: "Thịt heo xay, thường dùng làm nhân; chú ý lượng mỡ thêm từ dầu/mỡ khi chế biến.",
    gout: {
      purine: 120,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 50, description: '1 phần thịt bằm (ước tính)' },
    ],
  },
  {
    id: "thit-bo-bam",
    ...
    fat: 17.0,
    cholesterol: 80,
    commonServing: "1 phần bò bằm xào (~50–70g)",
    notes: "Thịt bò xay, dùng trong sốt spaghetti, bò viên, chả…; giàu sắt, nhưng cũng nhiều cholesterol.",
    gout: {
      purine: 130,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 50, description: '1 phần bò bằm (ước tính)' },
    ],
  },
  {
    id: "thit-cuu",
    ...
    fat: 17.0,
    cholesterol: 80,
    commonServing: "1 phần thịt cừu nấu chín (~90–100g)",
    notes: "Thịt đỏ; nhiều sắt, nhưng cũng nhiều chất béo bão hòa và cholesterol.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 30, description: '1 miếng thịt cừu' },
    ],
  },
  {
    id: "thit-de",
    ...
    fat: 2.6,
    cholesterol: 75,
    commonServing: "1 phần thịt dê nấu chín (~80–100g)",
    notes: "Thịt dê tương đối nạc so với bò/cừu; vẫn là thịt đỏ, cần cân nhắc ở bệnh tim mạch/gout.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 30, description: '1 miếng thịt dê' },
    ],
  },
  {
    id: "thit-vit-nac",
    ...
    fat: 4.5,
    cholesterol: 80,
    commonServing: "1 phần thịt vịt nạc (~80–100g)",
    notes: "Bỏ da giúp giảm mỡ bão hòa; vẫn là thịt gia cầm giàu cholesterol.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 30, description: '1 miếng thịt vịt nạc' },
    ],
  },
  {
    id: "thit-ngan",
    name: "Thịt ngan",
    nameEn: "Muscovy duck meat",
    category: "meat",
    servingSize: 100,
    servingUnit: "g",
    calories: 160,
    ...
    fat: 7.0,
    cholesterol: 85,
    commonServing: "1 phần thịt ngan nấu chín (~80–100g)",
    notes: "Thịt gia cầm đậm đà, nhiều mỡ hơn gà; nên bỏ da, hạn chế ở người tăng mỡ máu.",
    gout: {
      purine: 150,
      purineLevel: 'high',
    },
    ...
    vietnameseUnits: [
      { unit: 'mieng', weight: 30, description: '1 miếng thịt ngan' },
    ],
  },
];
